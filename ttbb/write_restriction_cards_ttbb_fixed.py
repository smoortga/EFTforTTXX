...
#     
        ...
        runfile.write("generate p p > t t~ b b~ QED=0 , (t > w+ b, w+ > l+ vl), (t~ > w- b~, w- > l- vl~); output MODELSCAN_ttbb_DiLepton_ForValidationPerCouplings_myModel_testAcceptance/%s/%s \n"%(param,param+"_"+str(val).replace(".","p").replace("-","minus")))
