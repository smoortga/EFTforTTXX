...
file_tttt = open("limits_tttt.txt","r")
...
file_xsec = open("limits_xsec_40.txt","r")
...
file_NN = open("limits_NN_40.txt","r")
...
l.SetFillStyle(1001)
l.SetTextSize(0.037)
l.AddEntry(gr_NN,"ttcc neural network fixed (2#sigma)","l")
l.AddEntry(gr_xsec,"ttcc cross section fixed (2#sigma)","l")
l.AddEntry(gr_tttt,"arXiv:1708.05928 (tttt) marg. (2#sigma)","l")
l.Draw("same")
