...
def makeDiscr(discr_dict,outfile,xtitle="discriminator"):
    ...
    for leg,discr in discr_dict.iteritems():
        ...
        a.GetXaxis().SetTitleOffset(1.4)
        a.Scale(1./a.Integral())
        #a.GetYaxis().SetRangeUser(0.00001,100)
        a.GetYaxis().SetRangeUser(0,0.35)
...
def main():
    ...
    parser.add_argument('--InputDir', default = "/user/smoortga/Analysis/MG5_aMC_v2_6_0/CONVERTED_DELPHES_Training_WithInterference", help='path to the converted delphes files')
