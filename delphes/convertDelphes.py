...
def Convert(infilepath, outfilepath):
    ...
    dict_variableName_Leaves.update({"m_b1W1": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"m_b2W2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"m_b1b2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"m_W1W2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"m_c1c2b1b2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"m_c1c2b1b2W1W2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"deltaR_c1c2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"deltaR_b1W1": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"deltaR_b2W2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"deltaR_b1b2": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"deltaR_W1W2": [array('d', [0]),"D"]})
    ...
    dict_variableName_Leaves.update({"pT_W1": [array('d', [0]),"D"]})
    dict_variableName_Leaves.update({"pT_W2": [array('d', [0]),"D"]})
    ...
    for evt in range(nEntries):
        ...
        particle_dict = { # name: [vector, filled]
            "W1": [ROOT.TLorentzVector(),False],
            "W2": [ROOT.TLorentzVector(),False],
        ...
        for iPart in range(18):#range(chain.Particles_size):
            ...
            if part.PID == 4 or part.PID == -4:
                ...
                if particle_dict["W1"][1] == False: 
                    particle_dict["W1"][0].SetPtEtaPhiE(part.PT,part.Eta,part.Phi,part.E)
                    particle_dict["W1"][1] = True
                elif particle_dict["W2"][1] == False: 
                    particle_dict["W2"][0].SetPtEtaPhiE(part.PT,part.Eta,part.Phi,part.E)
                    particle_dict["W2"][1] = True
        ...
        if particle_dict["W2"][0].DeltaR(particle_dict["b1"][0]) < particle_dict["W1"][0].DeltaR(particle_dict["b1"][0]):
            save = ROOT.TLorentzVector()
            save.SetPtEtaPhiE(particle_dict["W1"][0].Pt(),particle_dict["W1"][0].Eta(),particle_dict["W1"][0].Phi(),particle_dict["W1"][0].E())
            particle_dict["W1"][0] = particle_dict["W2"][0]
            particle_dict["W2"][0] = save
        
        
        # Fill output
        dict_variableName_Leaves["m_c1c2"][0][0] = (particle_dict["add1"][0]+ particle_dict["add2"][0]).M()
        dict_variableName_Leaves["m_b1W1"][0][0] = (particle_dict["b1"][0]+ particle_dict["W1"][0]).M()
        dict_variableName_Leaves["m_b2W2"][0][0] = (particle_dict["b2"][0]+ particle_dict["W2"][0]).M()
        dict_variableName_Leaves["m_b1b2"][0][0] = (particle_dict["b1"][0]+ particle_dict["b2"][0]).M()
        dict_variableName_Leaves["m_W1W2"][0][0] = (particle_dict["W1"][0]+ particle_dict["W2"][0]).M()
        ...
        dict_variableName_Leaves["m_c1c2b1b2W1W2"][0][0] = (particle_dict["add1"][0]+ particle_dict["add2"][0]+particle_dict["b1"][0]+ particle_dict["b2"][0]+ particle_dict["W1"][0]+ particle_dict["W2"][0]).M()
        dict_variableName_Leaves["deltaR_c1c2"][0][0] = particle_dict["add1"][0].DeltaR(particle_dict["add2"][0])
        dict_variableName_Leaves["deltaR_b1W1"][0][0] = particle_dict["b1"][0].DeltaR(particle_dict["W1"][0])
        dict_variableName_Leaves["deltaR_b2W2"][0][0] = particle_dict["b2"][0].DeltaR(particle_dict["W2"][0])
        dict_variableName_Leaves["deltaR_b1b2"][0][0] = particle_dict["b1"][0].DeltaR(particle_dict["b2"][0])
        dict_variableName_Leaves["deltaR_W1W2"][0][0] = particle_dict["W1"][0].DeltaR(particle_dict["W2"][0])
        ...
        dict_variableName_Leaves["pT_W1"][0][0] = particle_dict["W1"][0].Pt()
        dict_variableName_Leaves["pT_W2"][0][0] = particle_dict["W2"][0].Pt()
        otree.Fill()
...
def main():
    ...
    #Convert("/user/smoortga/Analysis/MG5_aMC_v2_6_0/MODELSCAN_ttcc_inclusive_perOrder/C1tu/C1tu1p0_Order0/Events/run_01/tag_1_delphes_events.root",workingdir+"/CONVERTED_DELPHES_"+args.tag+"/out_test.root")
